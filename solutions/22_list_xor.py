...
"""
"""
list_xor adında bir fonksiyon yazın.Fonksiyonunuz üç parametre almalı,
n, list1, list2

Fonksiyonunuz n sadece list1 veya list2 içerisinde var ise True dönmelidir.
Yani eğer n her iki listede de yoksa veya her iki listede de varsa False dönmelidir.
Mesela;
list_xor(1, [1, 2, 3], [4, 5, 6]) == True
list_xor(1, [0, 2, 3], [1, 5, 6]) == True
list_xor(1, [1, 2, 3], [1, 5, 6]) == False
